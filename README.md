...
5. **薪資計算**：依出勤天數與日平均件數自動判定職稱（資深員工/員工/臨時工 × 高/低），管理者可逐月手動覆蓋；含職務加給、貨車司機/隨車加給、激勵獎金、扣款項目；單一員工薪資單匯出 PDF（內嵌 Logo 與思源黑體），全公司薪資總表匯出 Excel
...
9. **管理者儀表板**：當日/當月統計、預估營收與毛利、車輛狀況、待處理事項提醒、快速連結
